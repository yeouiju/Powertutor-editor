...
static char ue_addressList[2][24] = {"7.0.0.0", "107.0.0.0"};
static char s5_addressList[2][24] = {"14.0.0.0", "114.0.0.0"};
static char s11_addressList[2][24] = {"13.0.0.0", "113.0.0.0"};
static char x2_addressList[2][24] = {"12.0.0.0", "112.0.0.0"};
namespace ns3 {
      ...
      m_s5LinkMtu (3000)
{
  ...
  m_x2Ipv4AddressHelper.SetBase (x2_addressList[epcCount], "255.255.255.252");
  // m_s11Ipv4AddressHelper.SetBase ("13.0.0.0", "255.255.255.252");
  m_s11Ipv4AddressHelper.SetBase (s11_addressList[epcCount], "255.255.255.252");
  // m_s5Ipv4AddressHelper.SetBase ("14.0.0.0", "255.255.255.252");
  m_s5Ipv4AddressHelper.SetBase (s5_addressList[epcCount], "255.255.255.252");

  // we use a /8 net for all UEs
  // m_uePgwAddressHelper.SetBase ("7.0.0.0", "255.0.0.0");
  m_uePgwAddressHelper.SetBase (ue_addressList[epcCount], "255.0.0.0");
  epcCount++;
...
void
NoBackhaulEpcHelper::AddEnb (Ptr<Node> enb, Ptr<NetDevice> lteEnbNetDevice,
...
void
NoBackhaulEpcHelper::SetAddress ()
{
