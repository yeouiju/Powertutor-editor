...
static char s1u_addressList[2][24] = {"10.0.0.0", "100.0.0.0"};
static char s1ap_addressList[2][24] = {"11.0.0.0", "111.0.0.0"};
...
PointToPointEpcHelper::PointToPointEpcHelper () : NoBackhaulEpcHelper ()
{
  ...
  m_s1uIpv4AddressHelper.SetBase (s1u_addressList[epcCount], "255.255.255.252");
  // m_s1apIpv4AddressHelper.SetBase ("11.0.0.0", "255.255.255.252");
  m_s1apIpv4AddressHelper.SetBase (s1ap_addressList[epcCount], "255.255.255.252");
  epcCount++;
}
...
void
PointToPointEpcHelper::AddEnb (Ptr<Node> enb, Ptr<NetDevice> lteEnbNetDevice,
