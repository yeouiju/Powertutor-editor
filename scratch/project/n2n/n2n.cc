...
main (int argc, char *argv[])
{
  ...
  NodeContainer nodes;
  nodes.Create (2);
  NS_LOG_INFO ("Create " << nodes.GetN () << " nodes");

  NS_LOG_INFO ("Create a channel & 2 PointToPointNetDevice.");
  ...
  NetDeviceContainer net_devices = csma_p2p.Install (nodes);
  ...
  NS_LOG_INFO ("echoClient: MaxPackets=2, Interval=1s, PacketSize=1024");
  std::cout << std::endl;
